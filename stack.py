...
if __name__ == "__main__":
    ...
    # b = RankDegenerateBernoulliProcess( (3,3,3), quadratic_channels=5, linear_channels=3)


    s = Stack('data/smaller.hdf5', preprocessor=lambda x: preprocess(x).mean(axis=-1).squeeze())
    b = RankDegenerateBernoulliProcess( (9,9,7), quadratic_channels=10, linear_channels=5)
